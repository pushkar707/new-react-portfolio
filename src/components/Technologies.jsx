...
import {  SiGithubactions, SiGrafana, SiJest, SiMongodb, SiPrometheus, SiSocketdotio, SiTailwindcss, SiTypescript } from "react-icons/si";
    ...
    <div className="border-b border-neutral-800 pb-24">
      ...
      >
        ...
        <motion.div
          ...
          className="rounded-2xl border-4 border-neutral-800 p-4"
        >
          <SiJest className="text-7xl text-red-900" />
        </motion.div>
        <motion.div
          variants={iconVariants(2.5)}
          initial="initial"
        ...
        <motion.div
          ...
          className="rounded-2xl border-4 border-neutral-800 p-4"
        >
          <SiGrafana className="text-7xl text-orange-700" />
        </motion.div>
        <motion.div
          variants={iconVariants(2.5)}
          initial="initial"
